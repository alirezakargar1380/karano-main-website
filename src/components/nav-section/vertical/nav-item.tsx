...
export const CustomNavItem = forwardRef<HTMLDivElement, NavItemProps>(
  (
    {
      title,
      path,
...
const StyledNavItem = styled(ListItemButton, {
  ...
  const baseStyles = {
    item: {
      ...
      padding: theme.spacing('14px', '14px'),
    },
    icon: {
      width: 24,
      height: 24,
...
const NewStyledNavItem = styled(ListItemButton, {
  shouldForwardProp: (prop) => prop !== 'active',
})<NavItemStateProps>(({ active, open, depth, theme }) => {
  const subItem = depth !== 1;
  ...
  const baseStyles = {
    item: {
      ...
      borderRadius: 8,
      color: "#2B2B2B",
      padding: theme.spacing('14px', '26px'),
  ...
  return {
    ...
    ...(!subItem && {
      ...
      ...(active && {
        color:
          theme.palette.mode === 'light' ? "##2B2B2B" : theme.palette.primary.light,
